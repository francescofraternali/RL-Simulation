...
on_off = 1 # 0 is off and it uses 10 light levels. With 1 light is just on or off
...
tot_episodes = 1000; Text = "Q-Table, SC, Light, Time_H, e_min = 0.001"
...
def update():
    ...
    for episode in range(tot_episodes):
        ...
        Light = 2; Perc = 0; cnt = 0; perf = 2; time_temp = 4; reward = 0; R = 0; done = False; Occupancy = 0
        ...
        print("QTable-Episode:", episode, "Steps:", len(Time_hist), "Reward:", R, "Started Time:", Start_Real_Time)
        ...
        if R > best_reward:
            ...
            #rp.plot_reward_text(Tot_Episodes, Tot_Reward, "QLearning Table, SC, Light, Time_H")
