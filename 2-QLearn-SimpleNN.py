...
SampleSam =[];
#global SampleSam; global Text; global episodes
MEMORY_CAPACITY = 1000000  # It was 100000
MIN_EPSILON = 0.001 # Default 0.01
tot_episodes = 1000; Text = "Q-SimpleNN, SC, Light, E_min = " + str(MIN_EPSILON) + "Mem =  " + str(MEMORY_CAPACITY)
...
class Environment:
    ...
    def run(self, agent):
        ...
        while True: # here it's like the agent(BS) wakes up and sense the light and battery
            ...
            # Update s
            s_[0] = SC_feed; s_[1] = Light_feed; #s_[2] = perf; s_[3] = curr_time_h;
        ...
        print("Q-Simple-Episode: " + str(episode) + ", Steps: " + str(len(Time_hist)) + ", Reward: " + str(R) + ", Started Time: "+ Start_Real_Time)
        ...
        #rp.plot_legend_text(Time_hist, Light_hist, Light_feed_hist, Action_hist, r_hist, perf_hist, SC_hist, SC_norm_hist, SC_feed_hist, Occup_hist,"QLearn-SimpleNN, SC, Light, Mem = 5M")
        #rp.plot_reward_text(Tot_Episodes, Tot_Reward,"QLearn-SimpleNN Mem = 5M")
